...
% Below for fancy path integral D
...
\begin{titlepage}
	\centering
	    ...
	    {\scshape\Large Dr. Nabil Iqbal} % Lecturer Name
...
\mybox{There was a strike during the course and 6 hours of the course were not taught. However, Dr. Iqbal gave us notes for the bits missed, so I have also included those here. This is the content of chapters 5, 6 \& 8. For this reason I have grouped the material according to Dr. Iqbal's chapters rather then the lecture numbers (as I normally do).}
...
\input{sections/02FreeTheory.tex}
\input{sections/03LSZ.tex}
\input{sections/04Loops.tex}
\input{sections/05Global.tex}
\input{sections/06Fermions.tex}
\input{sections/07Abelian.tex}
\input{sections/08Nonabelian.tex}
